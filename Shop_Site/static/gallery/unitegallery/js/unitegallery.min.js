...
function UG_API(e) {
    ...
    var i, n = this, r = (jQuery(n), new UniteGalleryMain);
...
function UGAviaControl() {
    ...
    function i(e) {
        var t = g.height(), i = c.height();
        if (t > i)return !1;
        var n = g.offset(), r = n.top, a = e - r, o = h.thumb_height, s = t - h.thumb_height, l = s - o;
        o > a && (a = o), a > s && (a = s);
        var u = (a - o) / l, d = (i - t) * u;
    ...
    function n(e) {
        var t = g.width(), i = c.width();
        if (t > i)return !1;
        var n = g.offset(), r = n.left, a = e - r, o = h.thumb_width, s = t - h.thumb_width, l = s - o;
        o > a && (a = o), a > s && (a = s);
        var u = (a - o) / l, d = (i - t) * u;
        return d = Math.round(d), d = -1 * d
    }
...
function UGFunctions() {
    ...
    this.z__________FULL_SCREEN___________ = function () {
        ...
        if (document.exitFullscreen)document.exitFullscreen(); else if (document.mozCancelFullScreen)document.mozCancelFullScreen(); else {
        ...
        var n = e.parent(), r = i.getImageOriginalSize(e), a = i.getImageInsideParentData(n, r.width, r.height, t);
        return a
    }, this.getImageInsideParentData = function (e, t, i, n) {
        var r = {}, a = e.width(), o = e.height(), s = null, l = "100%", u = null, d = null, _ = "display:block;margin:0px auto;";
        if (t > 0 && i > 0) {
            if ("down" == n && a > t && o > i)l = i, s = t, d = (a - s) / 2, u = (o - l) / 2; else if ("fill" == n) {
                var g = t / i;
        ...
        var t = e.parent(), n = i.getElementSize(e), r = i.getElementSize(t), a = {};
        ...
        var i = {pageX: e.pageX, pageY: e.pageY};
        ...
        var r = e.parent(), a = i.getElementSize(e), o = i.getElementSize(r);
        switch (t) {
            case"top":
            case"left":
                t = 0, n && (t += n);
    ...
    }, this.zoomImageInsideParent = function (e, t, n, r, a, o) {
        if (!n)var n = 1.2;
        if (!a)var a = "fit";
        var s, l, u, d, _ = n, g = e.parent(), c = i.getElementSize(e), h = i.getImageOriginalSize(e), p = !1, m = 0, f = 0, v = 0, b = 0;
        if (r) {
        ...
        if (1 == t)s = c.height * _, l = c.width * _, 0 != v && (m = -(v * _ - v)), 0 != b && (f = -(b * _ - b)); else {
            s = c.height / _, l = c.width / _;
            var w = i.getImageInsideParentData(g, h.width, h.height);
            if (l < w.imageWidth)return i.scaleImageFitParent(e, h.width, h.height, a), !0;
        ...
        if (0 == jQuery.isNumeric(t) || 0 == jQuery.isNumeric(n))var o = e.parent(), s = i.getElementSize(e), l = i.getElementSize(o);
        ...
        var n = {width: t + "px", height: i + "px"};
        e.css(n)
    }, this.placeImageInsideParent = function (e, t, n, r, a) {
        var o = i.getImageInsideParentData(t, n, r, a), s = "<img";
        ...
        var i = t.outerWidth(), n = t.outerHeight(), r = e.outerWidth(), a = e.outerHeight(), o = r / a, s = n, l = s * o, u = 0, d = 0;
        ...
        var a = e.parent(), o = i.getImageInsideParentData(a, t, n, r), s = !1, l = {};
...
function UniteGalleryMain() {
    ...
    function initTheme(objParams) {
        if (objParams.hasOwnProperty("gallery_theme"))g_options.gallery_theme = objParams.gallery_theme; else {
    ...
    function fillItemsArray(e) {
        for (var t = 0; t < e.length; t++) {
            var i = jQuery(e[t]), n = i.data("type");
            void 0 == n && (n = "image");
            var r = i.prop("tagName").toLowerCase(), a = {};
            if (a.index = t, a.type = n, "img" == r)a.urlThumb = i.attr("src"), a.title = i.attr("alt"), a.objThumbImage = i; else {
                if ("image" == n)throw new Error("The item should not be image type");
                a.urlThumb = i.data("thumb"), a.title = i.data("title"), a.objThumbImage = null
            }
            a.description = i.data("description"), a.description || (a.description = ""), a.isLoaded = !1, a.isThumbImageLoaded = !1, a.objPreloadImage = null, a.urlImage = i.data("image"), a.isBigImageLoadStarted = !1, a.isBigImageLoaded = !1, a.isBigImageLoadError = !1, a.imageWidth = 0, a.imageHeight = 0;
            var o = void 0 == a.urlImage || "" == a.urlImage, s = void 0 == a.urlThumb || "" == a.urlThumb;
            switch (a.type) {
                case"youtube":
    ...
    function onKeyPress(e) {
        var i = e.altKey, n = e.charCode ? e.charCode : e.keyCode ? e.keyCode : e.which ? e.which : 0;
        switch (n) {
            case 39:
                t.nextItem();
                break;
    ...
    function onFullScreenChange() {
        var e = g_functions.isFullScreen(), i = e ? t.events.ENTER_FULLSCREEN : t.events.EXIT_FULLSCREEN;
    ...
    var t = this, g_galleryID, g_objGallery = jQuery(t), g_objWrapper, g_objStrip, g_objStripInner, g_objThumbs, g_objSlider, g_functions = new UGFunctions, g_arrItems = [], g_numItems, g_selectedItem = null, g_selectedItemIndex = -1, g_objTheme;
    this.events = {
    ...
    this.onItemBigImageLoaded = function (e, t) {
        ...
        g_objWrapper.css("max-width", e + "px"), t && g_objWrapper.height(t), i || i === !0 || onGalleryResized()
        ...
        if (t && t.hasOwnProperty("gallery_debug_errors") && (g_options.gallery_debug_errors = t.gallery_debug_errors), 1 == g_options.gallery_debug_errors)try {
            ...
            if ("object" == typeof i) {
                {
                    var n = i, r = i.lineNumber, a = i.fileName;
                    i.stack
                }
...
function UGGridPanel() {
    function e(e, i) {
        ...
        var n = j.getOptions(), r = n.gallery_skin;
        "" == M.gridpanel_arrows_skin && (M.gridpanel_arrows_skin = r);
        var a = e.getObjects();
        I = a.g_objWrapper, A.init(j, O, E, M, T)
    }
    ...
    function n() {
        I.append("<div class='ug-grid-panel'></div>"), w = I.children(".ug-grid-panel"), O.isHorType ? (w.append("<div class='grid-arrow grid-arrow-left-hortype ug-skin-" + M.gridpanel_arrows_skin + "'></div>"), w.append("<div class='grid-arrow grid-arrow-right-hortype ug-skin-" + M.gridpanel_arrows_skin + "'></div>"), S = w.children(".grid-arrow-left-hortype"), P = w.children(".grid-arrow-right-hortype")) : 0 == M.gridpanel_vertical_scroll ? (w.append("<div class='grid-arrow grid-arrow-left ug-skin-" + M.gridpanel_arrows_skin + "'></div>"), w.append("<div class='grid-arrow grid-arrow-right ug-skin-" + M.gridpanel_arrows_skin + "'></div>"), S = w.children(".grid-arrow-left"), P = w.children(".grid-arrow-right")) : (w.append("<div class='grid-arrow grid-arrow-up ug-skin-" + M.gridpanel_arrows_skin + "'></div>"), w.append("<div class='grid-arrow grid-arrow-down ug-skin-" + M.gridpanel_arrows_skin + "'></div>"), S = w.children(".grid-arrow-up"), P = w.children(".grid-arrow-down")), A.setHtml(w), S.fadeTo(0, 0), P.fadeTo(0, 0), M.parent_container = w, j.initThumbsPanel("grid", M);
        var e = j.getObjects();
        C = e.g_objThumbs, r()
    }
    ...
    function o() {
        var e = M.gridpanel_padding_border_top + M.gridpanel_padding_border_bottom, t = O.panelHeight - e;
        if (0 == M.gridpanel_arrows_always_on) {
            var i = C.getNumPanesEstimationByHeight(t);
            if (1 == i)return t
        }
        var n = x.getElementSize(P), r = n.height, e = r + M.gridpanel_arrows_padding_vert;
    ...
    function s() {
        var e = M.gridpanel_padding_border_left + M.gridpanel_padding_border_right, t = O.panelWidth - e;
        if (0 == M.gridpanel_arrows_always_on) {
            var i = C.getNumPanesEstimationByWidth(t);
            if (1 == i)return t
        }
        var n = x.getElementSize(P), r = n.width;
    ...
    function u() {
        var e = C.getSize();
        1 == O.isHorType ? O.panelHeight = e.height + M.gridpanel_padding_border_top + M.gridpanel_padding_border_bottom : O.panelWidth = e.width + M.gridpanel_padding_border_left + M.gridpanel_padding_border_right, x.setElementSize(w, O.panelWidth, O.panelHeight)
    }
    ...
    function c() {
        var e, t, i, n, r = x.getElementSize(S), a = C.getSize();
    ...
    function p() {
        var e, t, i, n, r = x.getElementSize(S), a = C.getSize(), o = M.gridpanel_padding_border_top;
        switch (M.gridpanel_grid_align) {
            case"middle":
                switch (M.gridpanel_arrows_align_vert) {
                    default:
    ...
    var I, w, P, S, E = this, T = jQuery(this), j = new UniteGalleryMain, x = new UGFunctions, C = new UGThumbsGrid, A = new UGPanelsBase;
    ...
    }, z = {gridpanel_grid_align: "center"}, O = {
        panelType: "grid",
        isHorType: !1,
        arrowsVisible: !1,
        panelHeight: 0,
...
function UGPanelsBase() {
    function e(e, t) {
        ...
        a.stop(!0).animate(i, {
            duration: 300, easing: "easeInOutQuad", queue: !1, complete: function () {
                t && t()
            }
        })
    }
    ...
    var n, r, a, o, s, l, u, d = new UniteGalleryMain, _ = this, g = new UGFunctions;
    this.init = function (e, t, i, a, l) {
        n = t, r = i, d = e, o = a, s = l, u = jQuery(d)
    }, this.setHtml = function (e) {
        if (a = e, "strip" == n.panelType)var t = o.strippanel_enable_handle; else var t = o.gridpanel_enable_handle;
        if (1 == t && (l = new UGPanelHandle, l.init(r, a, o, n.panelType, d), l.setHtml()), n.isDisabledAtStart === !0) {
            var i = "<div class='ug-panel-disabled-overlay'></div>";
            a.append(i), setTimeout(function () {
                a.children(".ug-panel-disabled-overlay").hide()
...
function UGPanelHandle() {
    ...
    var a, o, s, l = new UGFunctions, u = {panel_handle_align: "top", panel_handle_offset: 0, panel_handle_skin: 0};
    this.init = function (e, t, i, n, r) {
        ...
        var e = o.getOrientation(), t = "ug-panel-handle-tip";
        switch (e) {
            case"right":
...
function UGSlider() {
    function e(e, t) {
        ...
        if (Z = n.g_objWrapper, q = n.g_objThumbs, t.hasOwnProperty("slider_progress_indicator_type") && (ft.slider_progress_indicator_type = t.slider_progress_indicator_type), "bar" == ft.slider_progress_indicator_type && (ft = jQuery.extend(ft, vt)), t && st.setOptions(t), i(), 1 == ft.slider_enable_bullets) {
            gt = new UGBullets;
            var r = {skin: ft.slider_bullets_skin, space_between: ft.slider_bullets_space_between};
            gt.init(ut, r)
        }
        ft.slider_enable_text_panel && (mt = new UGTextPanel, mt.init(ut, ft)), ft.slider_enable_zoom_panel && (ot = new UGZoomButtonsPanel, ot.init(st, ft));
        var a = ut.getGalleryID();
        ct.init(ft, !1, a)
    }
    ...
    function i() {
        var e = ut.getOptions(), t = e.gallery_skin;
    ...
    function r() {
        var e = D(), t = (ut.getOptions(), "<div class='ug-slider-wrapper'>");
        ...
        if (1 == ft.slider_enable_text_panel)if (0 == ft.slider_textpanel_always_on && 1 == hasControls && 0 == ft.slider_controls_always_on)mt.appendHTML(K); else if (mt.appendHTML(K), 0 == ft.slider_textpanel_always_on) {
            var r = mt.getElement();
    ...
    function u() {
        var e, t, i, n, r = st.getSlidesReference(), a = 0, o = 0, s = 0;
    ...
    function _(e, t) {
        ...
        switch (e) {
            case"right":
                ...
                var r = ht.getElementSize(n.objPrevSlide), a = -r.left;
                st.switchSlideNums("right");
                break;
            case"left":
                f(n.objNextSlide, t), u();
                var o = ht.getElementSize(n.objNextSlide), a = -o.left;
                st.switchSlideNums("left");
                break;
            default:
                throw new Error("wrong direction: " + e)
        }
        var s = ft.slider_transition_speed, l = ft.slider_transition_easing;
        J.animate({left: a + "px"}, {
            duration: s, easing: l, queue: !1, always: function () {
                if (null != bt.itemWaiting) {
                    var e = R(bt.itemWaiting);
                    _(e, bt.itemWaiting)
    ...
    function m(e, t, i) {
        var n = e.children(".ug-item-wrapper"), r = B(e), a = t.urlImage, o = e.data("urlImage");
        e.data("urlImage", a);
    ...
    function y() {
        var e = mt.getElement(), t = e.data("isHidden");
        return t === !1 ? !1 : !0
    }
    ...
    function R(e) {
        var t = st.getSlidesReference(), i = t.objCurrentSlide.data("index"), n = e.index, r = "left";
    ...
    var X, Z, q, K, J, $, et, tt, it, nt, rt, at, ot, st = this, lt = jQuery(st), ut = new UniteGalleryMain, dt = null, _t = null, gt = null, ct = new UGVideoPlayer, ht = new UGFunctions, pt = null, mt = null;
    this.events = {
    ...
    this.________EXTERNAL_GENERAL___________ = function () {
        ...
        var e = st.getSlidesReference(), t = ht.getElementSize(e.objCurrentSlide), i = -t.left, n = ht.getElementSize(J);
        return i == n.left ? !0 : !1
        ...
        var e = {objPrevSlide: W(bt.numPrev), objNextSlide: W(bt.numNext), objCurrentSlide: W(bt.numCurrent)};
        return e
    }, this.getCurrentSlide = function () {
        var e = st.getSlidesReference();
        return e.objCurrentSlide
    }, this.getCurrentItemIndex = function () {
        var e = st.getSlidesReference(), t = e.objCurrentSlide.data("index");
        ...
        var t = st.getSlidesReference(), i = t.objCurrentSlide.data("index"), n = e.index;
        if (n == i)return !0;
        var r = void 0 == i;
        if (r)f(t.objCurrentSlide, e), st.placeNabourItems(); else {
            var a = "left", o = ut.getNumItems();
            i == o - 1 && 0 == n ? a = "left" : 0 == i && n == o - 1 ? a = "right" : i > n && (a = "right"), d(a, e)
        }
    }, this.placeNabourItems = function () {
        var e = st.getSlidesReference(), t = e.objCurrentSlide.data("index"), i = ut.getPrevItem(t), n = ut.getNextItem(t);
        ...
        var e = {g_objSlider: K, g_objInner: J, g_options: ft, g_objZoomSlider: at};
        return e
        ...
        var a = e - ft.slider_item_padding_left - ft.slider_item_padding_right, s = t - ft.slider_item_padding_top - ft.slider_item_padding_bottom, l = {};
...
function UGTextPanel() {
    function e(e, t) {
        ...
        if (u) {
            ...
            var a = p.getElementSize(u), i = a.bottom
        }
        var o = "";
    ...
    function i() {
        var i = t(), n = (g.height() - i) / 2;
        e(!1, n)
    }

    function n() {
        var i = t(), n = g.height() - i - m.slider_textpanel_padding_bottom;
        e(!1, n)
    }
    ...
    var s, l, u, d, _, g, c, h = this, p = new UGFunctions, m = {
    ...
    this.positionElements = function (t) {
        ...
        if (1 == m.slider_textpanel_enable_bg && (t += "<div class='ug-textpanel-bg'></div>"), t += "<div class='ug-textpanel-textwrapper'>", 1 == m.slider_textpanel_enable_title && (t += "<div class='ug-textpanel-title'></div>"), 1 == m.slider_textpanel_enable_description && (t += "<div class='ug-textpanel-description'></div>"), t += "</div></div>", e.append(t), s = e.children(".ug-textpanel"), 1 == m.slider_textpanel_enable_bg) {
            ...
            var i = {"background-color": m.slider_textpanel_bg_color};
        ...
        var e = p.getElementSize(l), t = e.width, i = 80;
        m.slider_textpanel_height && (i = m.slider_textpanel_height), s.width(t), s.height(i), _ && (_.width(t), _.height(i));
        var n = t - m.slider_textpanel_padding_left - m.slider_textpanel_padding_right, r = m.slider_textpanel_padding_left;
...
function UGZoomButtonsPanel() {
    ...
    var r, a, o, s, l, u = this, d = new UGSlider, _ = new UGFunctions, g = {slider_zoompanel_skin: ""};
    this.init = function (e, t) {
...
function UGBullets() {
    ...
    var r, a, o = this, s = 0, l = new UniteGalleryMain, u = -1, d = new UGFunctions, _ = {isInited: !1}, g = {
        skin: "",
        space_between: -1
    };
    this.events = {BULLET_CLICK: "bullet_click"}, this.init = function (e, t) {
        l = e, s = l.getNumItems(), _.isInited = !0, g = jQuery.extend(g, t)
    }, this.appendHTML = function (e) {
        a = e, n();
        var i = "<div class='ug-slider-control ug-bullets ug-skin-" + g.skin + "'>", o = "";
        -1 != g.space_between && (o = " style='margin-left:" + g.space_between + "px'");
        ...
        if (i(e), "number" != typeof e)var t = e; else var t = r.children(".ug-bullet")[e];
        return t.hasClass("ug-bullet-active") ? !0 : !1
    }
}
function UGProgressBar() {
    var e, t, i = this, n = 0, r = new UGFunctions, a = {
    ...
    this.put = function (i, n) {
        ...
        var r = a.slider_progressbar_opacity, o = t[0];
...
function UGProgressPie() {
    function e(e) {
        if (!e)var e = 0;
        var t = Math.min(o.slider_progresspie_width, o.slider_progresspie_height) / 2, n = i[0].getContext("2d");
        0 == r && (r = !0, n.rotate(1.5 * Math.PI), n.translate(-2 * t, 0)), n.clearRect(0, 0, o.slider_progresspie_width, o.slider_progresspie_height);
        var a = o.slider_progresspie_width / 2, s = o.slider_progresspie_height / 2, l = 0, u = e * Math.PI * 2;
        if (1 == o.slider_progresspie_type_fill)n.beginPath(), n.moveTo(a, s), n.arc(a, s, t, l, u), n.lineTo(a, s), n.fillStyle = o.slider_progresspie_color1, n.fill(), n.closePath(); else {
    ...
    var t, i, n = this, r = !1, a = new UGFunctions, o = {
    ...
    this.put = function (e, t) {
        ...
        var e = {width: o.slider_progresspie_width, height: o.slider_progresspie_height};
        return e
...
function UGStripPanel() {
    function e(e, t) {
        ...
        var n = S.getOptions(), r = n.gallery_skin;
        "" == x.strippanel_buttons_skin && (x.strippanel_buttons_skin = r), v = S.getElement(), j.init(S, M, w, x, P), S.initThumbsPanel("strip", x);
        var a = S.getObjects();
        T = a.g_objThumbs
    }
    ...
    function n(e) {
        ...
        j.setHtml(b), T.setHtml(b), 1 == x.strippanel_enable_buttons && (I = b.children("." + t), y = b.children("." + i)), r()
    }
    ...
    function a() {
        var e = T.getHeight(), t = M.panelWidth;
        if (y) {
    ...
    function o() {
        var e = T.getWidth(), t = M.panelHeight;
        if (y) {
            I.width(e), y.width(e);
            var i = I.children(".ug-strip-arrow-tip");
            E.placeElement(i, "center", "middle");
    ...
    function l() {
        y && (E.placeElement(I, "left", "top", x.strippanel_padding_left, x.strippanel_padding_top), E.placeElement(y, "right", "top", x.strippanel_padding_right, x.strippanel_padding_top));
        var e = x.strippanel_padding_left;
        y && (e += y.outerWidth() + x.strippanel_padding_buttons), T.setPosition(e, x.strippanel_padding_top)
    }

    function u() {
        y && (E.placeElement(I, "left", "top", x.strippanel_padding_left, x.strippanel_padding_top), E.placeElement(y, "left", "bottom", x.strippanel_padding_left, x.strippanel_padding_bottom));
    ...
    function c() {
        if (!y)return !0;
        if (0 == T.isMoveEnabled())return E.disableButton(I), E.disableButton(y), !0;
        var e = T.getInnerStripLimits(), t = T.getInnerStripPos();
        t >= e.maxPos ? E.disableButton(I) : E.enableButton(I), t <= e.minPos ? E.disableButton(y) : E.enableButton(y)
    }
    ...
    function p() {
        S.isLastItem() ? E.disableButton(y) : E.enableButton(y), S.isFirstItem() ? E.disableButton(I) : E.enableButton(I)
    }

    function m() {
        if (1 == M.isEventsInited)return !1;
        if (M.isEventsInited = !0, y)if (E.addClassOnHover(y, "ug-button-hover"), E.addClassOnHover(I, "ug-button-hover"), E.setButtonOnClick(I, g), E.setButtonOnClick(y, _), "advance_item" != x.strippanel_buttons_role)jQuery(T).on(T.events.STRIP_MOVE, h), f.on(S.events.SIZE_CHANGE, c); else {
            var e = S.getOptions();
    ...
    var f, v, b, y, I, w = this, P = jQuery(this), S = new UniteGalleryMain, E = new UGFunctions, T = new UGThumbsStrip, j = new UGPanelsBase;
    this.events = {FINISH_MOVE: "gridpanel_move_finish", OPEN_PANEL: "open_panel", CLOSE_PANEL: "close_panel"};
    var x = {
    ...
    this.getOrientation = function () {
        ...
        j.setDisabledAtStart(e)
    }
}
function UGThumbsGeneral() {
    function e() {
        var e = "ug-thumb-image-overlay", t = P.thumb_image_overlay_type.split(",");
        for (var i in t) {
            var n = t[i];
            switch (n) {
                case"bw":
    ...
    function t(e, t) {
        e.stop(!0).animate(t, {duration: P.thumb_transition_duration, easing: P.thumb_transition_easing, queue: !1})
    }

    function i(e, i, n, r) {
        if (!r)var r = !1;
        I.isFakeFullscreen() && (r = !0);
        var a = e.children(".ug-thumb-border-overlay"), o = {};
    ...
    function n(e, t, i) {
        var n = e.children(".ug-thumb-overlay"), r = {};
    ...
    function r(e, t, i) {
        var n = e.children("img.ug-thumb-image"), r = e.children("img.ug-thumb-image-overlay"), a = P.thumb_transition_duration;
    ...
    function d() {
        ...
        var e = {"border-radius": P.thumb_round_corners_radius + "px"};
        b.find(".ug-thumb-wrapper, .ug-thumb-wrapper .ug-thumb-border-overlay").css(e)
    }

    function _(e, t) {
        if (!t)var t = !1;
        var i = jQuery(e), n = i.parent(), r = n.index(), a = v[r];
        if (1 == a.isLoaded && t === !1)return !1;
        var o = a.isLoaded;
        if (a.isLoaded = !0, a.isThumbImageLoaded = !0, w.scaleImageCoverParent(i, n), 0 == o)if (n.children(".ug-thumb-loader").hide(), i.show(), 0 == P.thumb_image_overlay_effect)i.fadeTo(0, 1); else {
    ...
    function h() {
        ...
        for (var i = S.num_thumbs_checking > E.thumb_max_check_times, n = 0; n < v.length; n++) {
            ...
            if (1 != r.isLoaded) {
                ...
                if (a) {
                    e = !1;
                    var o = a.width(), s = w.getImageOriginalSize(a).width;
    ...
    var p, m, f, v, b, y = this, I = new UniteGalleryMain, w = new UGFunctions, P = {
        thumb_width: 88,
        thumb_height: 50,
    ...
    }, E = {timeout_thumb_check: 100, thumb_max_check_times: 600};
    this.init = function (e, t) {
        m = e.getObjects(), I = e, p = jQuery(e), f = m.g_objWrapper, v = m.g_arrItems, P = jQuery.extend(P, t)
    }, this.setHtmlThumbs = function (t) {
        b = t;
        var i = I.getNumItems();
        if (1 == P.thumb_image_overlay_effect)var n = e();
        for (var r = 0; i > r; r++) {
            var a = jQuery("<div class='ug-thumb-wrapper'></div>"), o = v[r];
            if (1 == S.customThumbs)S.funcSetCustomThumbHtml(a, o); else {
        ...
        if (0 == S.customThumbs) {
            var e = {};
            e.width = P.thumb_width + "px", e.height = P.thumb_height + "px", b.children(".ug-thumb-wrapper").css(e), d()
        }
...
function UGThumbsGrid() {
    function e(e, i) {
        k = e.getObjects(), Q = e, M = jQuery(e), z = k.g_objWrapper, O = k.g_arrItems, R.numThumbs = O.length, u(i), R.isNavigationVertical = "top" == W.grid_panes_direction || "bottom" == W.grid_panes_direction, D.init(e), t()
    }

    function t() {
        var e = z;
        null != W.parent_container && (e = W.parent_container), e.append("<div class='ug-thumbs-grid'><div class='ug-thumbs-grid-inner'></div></div>"), N = e.children(".ug-thumbs-grid"), H = N.children(".ug-thumbs-grid-inner"), D.setHtmlThumbs(H)
    }

    function n() {
        if (0 == R.isHorizontal) {
            if (0 == R.gridHeight)throw new Error("You must set height before run.")
        } else if (0 == R.gridWidth)throw new Error("You must set width before run.")
    }

    function r() {
        var e = Q.getSelectedItem();
        n(), 1 == R.isFirstTimeRun && (D.setHtmlProperties(), s(), D.loadThumbsImages(), A()), c(), null != e && l(e.index), G.trigger(L.events.PANE_CHANGE), R.isFirstTimeRun = !1
    }

    function a() {
        var e = H.children(".ug-thumb-wrapper"), t = jQuery(e[0]), i = t.outerHeight(), n = R.gridWidth, r = W.grid_num_rows * i + (W.grid_num_rows - 1) * W.grid_space_between_rows;
        R.gridHeight = r, F.setElementSize(N, n, r), F.setElementSize(H, n, r), R.innerWidth = n, R.innerHeight = r
    }

    function o() {
        var e = H.children(".ug-thumb-wrapper"), t = jQuery(e[0]), i = t.outerWidth(), n = W.grid_num_cols * i + (W.grid_num_cols - 1) * W.grid_space_between_cols, r = R.gridHeight;
        R.gridWidth = n, F.setElementSize(N, n, r), F.setElementSize(H, n, r), R.innerWidth = n, R.innerHeight = r
    }

    function s() {
        0 == R.isHorizontal ? o() : a()
    }
    ...
    function u(e) {
        W = jQuery.extend(W, e), D.setOptions(e)
    }

    function d() {
        var e = H.children(".ug-thumb-wrapper"), t = 0, n = 0, r = 0, a = 0, o = 0, s = 0;
        R.innerWidth = 0, R.numPanes = 1, R.arrPanes = [], R.numThumbsInPane = 0, R.arrPanes.push(a);
        var l = e.length;
        for (i = 0; l > i; i++) {
            var u = jQuery(e[i]);
            ...
            g > s && (s = g);
            var c = o + d;
            c > R.innerWidth && (R.innerWidth = c), t += d + W.grid_space_between_cols, r++, r >= W.grid_num_cols && (n += _ + W.grid_space_between_rows, t = a, r = 0), 1 == R.numPanes && R.numThumbsInPane++, n + _ > R.gridHeight && (n = 0, a = R.innerWidth + W.grid_space_between_cols, t = a, r = 0, 1 == R.isMaxHeight && 1 == R.numPanes && (R.gridHeight = s, N.height(R.gridHeight)), l - 1 > i && (R.numPanes++, R.arrPanes.push(a)))
        }
        H.width(R.innerWidth), 1 == R.isMaxHeight && 1 == R.numPanes && (R.gridHeight = s, N.height(s))
    }

    function _() {
        var e = H.children(".ug-thumb-wrapper"), t = 0, n = 0, r = 0, a = 0, o = 0, s = 0;
        R.innerWidth = 0, R.numPanes = 1, R.arrPanes = [], R.numThumbsInPane = 0, R.arrPanes.push(o);
        var l = e.length;
        for (i = 0; l > i; i++) {
            var u = jQuery(e[i]);
            F.placeElement(u, t, n);
            var d = u.outerWidth(), _ = u.outerHeight();
            t += d + W.grid_space_between_cols;
            var g = n + _;
            g > r && (r = g), a++, a >= W.grid_num_cols && (n += _ + W.grid_space_between_rows, t = o, a = 0), 1 == R.numPanes && R.numThumbsInPane++, g = n + _;
            var c = s + R.gridHeight;
            g > c && (1 == R.isMaxHeight && 1 == R.numPanes && (R.gridHeight = r, N.height(R.gridHeight), c = R.gridHeight), n = c + W.grid_space_between_rows, s = n, o = 0, t = o, a = 0, l - 1 > i && (R.numPanes++, R.arrPanes.push(n)))
        }
        H.height(r), R.innerHeight = r, 1 == R.isMaxHeight && 1 == R.numPanes && (R.gridHeight = r, N.height(r))
    }

    function g() {
        var e = H.children(".ug-thumb-wrapper"), t = 0, n = 0, r = 0, a = 0, o = 0, s = 0, l = 0;
        R.innerWidth = 0, R.numPanes = 1, R.arrPanes = [], R.numThumbsInPane = 0, R.arrPanes.push(r);
        var u = e.length;
        for (i = 0; u > i; i++) {
            var d = jQuery(e[i]), _ = d.outerWidth(), g = d.outerHeight();
            t - r + _ > R.gridWidth && (l++, n = 0, l >= W.grid_num_rows ? (l = 0, r = t, s = 0, n = 0, 1 == R.numPanes && (R.gridWidth = a, N.width(R.gridWidth)), R.numPanes++, R.arrPanes.push(r)) : (t = r, n = s + W.grid_space_between_rows)), F.placeElement(d, t, n);
            var c = t + _;
            c > a && (a = c);
            var h = n + g;
            h > s && (s = h), h > o && (o = h);
            var c = a + _;
            c > R.innerWidth && (R.innerWidth = c), t += _ + W.grid_space_between_cols, 1 == R.numPanes && R.numThumbsInPane++
        }
        R.innerWidth = a, R.innerHeight = s, H.width(R.innerWidth), H.height(R.innerHeight), 1 == R.numPanes && (R.gridWidth = a, R.gridHeight = o, N.width(a), N.height(o))
    }

    function c() {
        0 == R.isHorizontal ? R.isNavigationVertical ? _() : d() : g()
    }

    function h(e) {
        if (0 > e || e >= R.numThumbs)throw new Error("Thumb not exists: " + e);
        return !0
    }

    function p(e) {
        if (e >= R.numPanes || 0 > e)throw new Error("Pane " + index + " doesn't exists.");
        return !0
    }
    ...
    function f(e) {
        ...
        return 0 == t ? !1 : void H.stop(!0).animate(t, {
            duration: W.grid_transition_duration,
            easing: W.grid_transition_easing,
            queue: !1
        })
    }

    function v() {
        var e = -R.arrPanes[R.currentPane];
        f(e)
    }

    function b() {
        return 1 == R.isNavigationVertical ? R.gridHeight : R.gridWidth
    }

    function y(e) {
        var t = {};
        return 1 == R.isNavigationVertical ? t.top = e + "px" : t.left = e + "px", t
    }

    function I(e) {
        var t = F.getMousePosition(e);
        return 1 == R.isNavigationVertical ? t.pageY : t.pageX
    }

    function w() {
        var e = F.getElementSize(H);
        return 1 == R.isNavigationVertical ? e.top : e.left
    }

    function P(e) {
        if (0 == h(e))return -1;
        var t = Math.floor(e / R.numThumbsInPane);
        return t
    }

    function S() {
        var e = jQuery.now(), t = e - R.startTime, i = w(), n = Math.abs(i - R.startInnerPos);
        return n > 30 ? !0 : n > 5 && t > 300 ? !0 : !1
    }

    function E() {
        var e = w();
        diffPos = Math.abs(R.startInnerPos - e);
        var t = b(), i = Math.round(3 * t / 8);
        if (diffPos >= i)return !0;
        var n = jQuery.now(), r = n - R.startTime;
        return 300 > r && diffPos > 25 ? !0 : !1
    }

    function T() {
        if (1 == S())return !0;
        var e = jQuery(this), t = D.getItemByThumb(e);
        Q.selectItem(t)
    }

    function j(e) {
        return 1 == R.numPanes ? !0 : 1 == R.touchActive ? !0 : (e.preventDefault(), R.touchActive = !0, R.startTime = jQuery.now(), R.startMousePos = I(e), void(R.startInnerPos = w()))
    }

    function x(e) {
        if (0 == R.touchActive)return !0;
        e.preventDefault();
        var t = I(e), i = t - R.startMousePos, n = R.startInnerPos + i, r = i > 0 ? "prev" : "next", a = R.arrPanes[R.numPanes - 1];
        0 == W.grid_carousel && n > 0 && "prev" == r && (n /= 3), 0 == W.grid_carousel && -a > n && "next" == r && (n = R.startInnerPos + i / 3), m(n)
    }

    function C() {
        if (0 == R.touchActive)return !0;
        if (R.touchActive = !1, 0 == E())return v(), !0;
        var e = w(), t = e - R.startInnerPos, i = t > 0 ? "prev" : "next";
        "next" == i ? 0 == W.grid_carousel && L.isLastPane() ? v() : L.nextPane() : 0 == W.grid_carousel && L.isFirstPane() ? v() : L.prevPane()
    }
    ...
    function A() {
        ...
        e.on("click touchend", T), M.on(Q.events.ITEM_CHANGE, function () {
            var e = Q.getSelectedItem();
            D.setThumbSelected(e.objThumbWrapper), l(e.index)
        }), N.bind("mousedown touchstart", j), jQuery("body").bind("mousemove touchmove", x), jQuery(window).add("body").bind("mouseup touchend", C)
    }

    var M, k, z, O, N, H, L = this, G = jQuery(this), Q = new UniteGalleryMain, F = new UGFunctions, D = new UGThumbsGeneral, W = {
    ...
    this.__________EXTERNAL_GENERAL_________ = function () {
        ...
        D.setThumbUnselected(e)
    }, this.isItemThumbVisible = function (e) {
        var t = e.index, i = P(t);
        return i == R.currentPane ? !0 : !1
    }, this.__________EXTERNAL_API_________ = function () {
    }, this.getNumPanesEstimationByHeight = function (e) {
        var t = D.getOptions(), i = t.thumb_height, n = D.getNumThumbs(), r = Math.ceil(n / W.grid_num_cols), a = r * i + (r - 1) * W.grid_space_between_rows, o = Math.ceil(a / e);
        return o
    }, this.getNumPanesEstimationByWidth = function (e) {
        var t = D.getOptions(), i = t.thumb_width, n = D.getNumThumbs(), r = Math.ceil(n / W.grid_num_rows), a = r * i + (r - 1) * W.grid_space_between_cols, o = Math.ceil(a / e);
        return o
    }, this.getElement = function () {
        return N
    }, this.getSize = function () {
        ...
        return 0 == R.currentPane ? !0 : !1
    }, this.isLastPane = function () {
        return R.currentPane == R.numPanes - 1 ? !0 : !1
    }, this.getPaneInfo = function () {
        var e = {pane: R.currentPane, total: R.numPanes};
        return e
    }, this.setWidth = function (e) {
        R.gridWidth = e, R.isHorizontal = !0
    }, this.setMaxWidth = function (e) {
        R.gridWidth = e, R.isMaxWidth = !0, R.isHorizontal = !0
    }, this.setHeight = function (e) {
        R.gridHeight = e, R.isHorizontal = !1
    }, this.setMaxHeight = function (e) {
        R.gridHeight = e, R.isMaxHeight = !0, R.isHorizontal = !1
    }, this.gotoPane = function (e) {
        if (0 == p(e))return !1;
        if (e == R.currentPane)return !1;
        var t = -R.arrPanes[e];
        R.currentPane = e, f(t), G.trigger(L.events.PANE_CHANGE)
    }, this.nextPane = function () {
        var e = R.currentPane + 1;
        if (e >= R.numPanes) {
            if (0 == W.grid_carousel)return !0;
            e = 0
        }
        L.gotoPane(e, "next")
    }, this.prevPane = function () {
        var e = R.currentPane - 1;
        return 0 > e && (e = R.numPanes - 1, 0 == W.grid_carousel) ? !1 : void L.gotoPane(e, "prev")
    }, this.setNextPaneButton = function (e) {
        return F.setButtonOnClick(e, L.nextPane), 1 == W.grid_carousel ? !0 : (L.isLastPane() && e.addClass("ug-button-disabled"), void G.on(L.events.PANE_CHANGE, function () {
            L.isLastPane() ? e.addClass("ug-button-disabled") : e.removeClass("ug-button-disabled")
        }))
    }, this.setPrevPaneButton = function (e) {
        return F.setButtonOnClick(e, L.prevPane), 1 == W.grid_carousel ? !0 : (L.isFirstPane() && e.addClass("ug-button-disabled"), void G.on(L.events.PANE_CHANGE, function () {
...
function UGThumbsStrip() {
    function e(e, t) {
        w = e.getObjects(), A = e, I = jQuery(e), P = w.g_objWrapper, S = w.g_arrItems, O = jQuery.extend(O, t), k = O.strip_vertical_type, 1 == k && (O = jQuery.extend(O, L), O = jQuery.extend(O, t)), z.init(e, t)
    }

    function t() {
        z.setHtmlProperties(), n(), s(), o(), 0 == N.isRunOnce && (1 == O.strip_control_touch && (x = new UGTouchThumbsControl, x.init(C)), 1 == O.strip_control_avia && (j = new UGAviaControl, j.init(C)), h(), z.loadThumbsImages(), f()), N.isRunOnce = !0
    }

    function n() {
        var e = T.children(".ug-thumb-wrapper"), t = jQuery(e[0]), i = t.outerWidth(), n = t.outerHeight();
    ...
    function r() {
        var e = T.children(".ug-thumb-wrapper"), t = 0, n = 0;
    ...
    function s() {
        if (0 == k) {
            var e = H.thumbSecondSize, t = {};
            t.height = e + "px";
            var i = {};
            i.height = e + "px"
        } else {
            var n = H.thumbSecondSize, t = {};
            t.width = n + "px";
            var i = {};
            i.width = n + "px"
        }
    ...
    function l(e) {
        var t = C.getInnerStripPos(), i = t + e;
    ...
    function d(e) {
        var t = y(e), i = -1 * t.max + H.stripSize;
        i = C.fixInnerStripLimits(i), C.positionInnerStrip(i, !0)
    }
    ...
    function c() {
        if (0 == v())return !1;
        var e = C.getInnerStripPos(), t = C.fixInnerStripLimits(e);
    ...
    function f() {
        ...
        e.on("click touchend", function () {
            var e = jQuery(this);
            m(e)
        }), I.on(A.events.ITEM_CHANGE, function () {
            var e = A.getSelectedItem();
    ...
    var I, w, P, S, E, T, j, x, C = this, A = new UniteGalleryMain, M = new UGFunctions, k = !1, z = new UGThumbsGeneral, M = new UGFunctions, O = {
    ...
    }, N = {isRunOnce: !1, is_placed: !1}, H = {stripSize: 0, stripInnerSize: 0, thumbSize: 0, thumbSecondSize: 0};
    this.events = {STRIP_MOVE: "stripmove"};
    var L = {strip_thumbs_align: "top"};
    this.setHtml = function (e) {
        if (!e) {
            var e = P;
        ...
        if (void 0 === t)var t = !1;
        if (0 == k)var i = {left: e + "px"}; else var i = {top: e + "px"};
        ...
        var t = e.objThumbWrapper, i = t.position(), n = -1 * C.getInnerStripPos();
        if (0 == k)var r = n + E.width(), a = i.left, o = i.left + t.width(); else var r = n + E.height(), a = i.top, o = i.top + t.height();
        var s = !1;
        ...
        var e = z.getOptions(), t = jQuery.extend(O, e), i = {
            g_gallery: A,
            g_objGallery: I,
            g_objWrapper: P,
            g_arrItems: S,
...
function UGTouchSliderControl() {
    function e(e) {
        ...
        var t = b.getElementSize(e.objCurrentSlide), i = -t.left, n = b.getElementSize(h), r = i - n.left;
        return r
    }

    function t() {
        var t = f.getSlidesReference(), i = e(t), n = Math.round(3 * t.objCurrentSlide.width() / 8);
        ...
        if (20 > r)return !1;
        var a = jQuery.now(), o = a - y.startTime;
        return 500 > o ? !0 : !1
    }
    ...
    function i(e) {
        ...
        var t = b.getElementSize(e.objCurrentSlide), i = -t.left;
        h.animate({left: i + "px"}, {
    ...
    function r() {
        var t = f.getSlidesReference(), r = e(t);
        if (0 == r)return !1;
        var a = r > 0 ? "left" : "right", o = !1;
        switch (a) {
            case"right":
                if (f.isSlideHasItem(t.objPrevSlide))var s = b.getElementSize(t.objPrevSlide), l = -s.left; else o = !0;
                break;
            case"left":
                if (f.isSlideHasItem(t.objNextSlide))var u = b.getElementSize(t.objNextSlide), l = -u.left; else o = !0
        }
        1 == o ? i(t) : h.stop().animate({left: l + "px"}, {
    ...
    function a(e) {
        ...
        if (0 == t)return !0;
        var i = 0 > t ? "left" : "right", n = f.getObjZoom();
        if (n) {
        ...
        var a = y.startPosx + t;
        if (t > 0 && a > 0)a /= 3; else if (0 > t) {
            var s = a + h.width(), l = c.width();
    ...
    function _(e) {
        var n = b.getArrTouches(e), a = n.length, o = f.isInnerInPlace();
    ...
    var c, h, p, m, f = new UGSlider, v = this, b = new UGFunctions;
    ...
    this.isTapEventOccured = function (t) {
        var i = b.getArrTouches(t), n = i.length;
        if (0 != n || 0 != y.lastNumTouches)return y.lastNumTouches = n, !1;
        y.lastNumTouches = n;
        var r = f.getSlidesReference(), a = (e(r), Math.abs(y.lastMouseX - y.startMouseX)), o = Math.abs(y.lastMouseY - y.startMouseY), s = jQuery.now(), l = s - y.startTime;
...
function UGTouchThumbsControl() {
    ...
    function t() {
        P.thumb_touch_slowFactor = w.normalizeSetting(5e-5, .01, 1, 100, y.strip_thumb_touch_sensetivity, !0)
    }
    ...
    function n(e) {
        var t = S.mousePos - e, i = S.innerPos - t, n = h.getInnerStripLimits();
        if (i > n.maxPos) {
            var r = i - n.maxPos;
            i = n.maxPos + r / 3
        }
    ...
    function a() {
        var e = jQuery.now(), t = e - S.lastTime;
    ...
    function o() {
        var e = P.thumb_touch_slowFactor, t = P.minDeltaTime, i = P.minPath, n = h.getInnerStripPos(), r = jQuery.now(), a = r - S.lastTime, o = n - S.lastPortionPos;
        t > a && S.lastDeltaTime > 0 && (a = S.lastDeltaTime, o = S.lastDeltaPos + o), t > a && (a = t);
        var l = o > 0 ? 1 : -1, u = 0;
        a > 0 && (u = o / a);
        var d = u * u / (2 * e) * l;
        Math.abs(d) <= i && (d = 0);
        var _ = h.getInnerStripPos(), g = _ + d, c = h.fixInnerStripLimits(g), p = h.getInnerStripLimits(), m = P.limitsBreakAddition, f = !1, v = c;
        if (g > p.maxPos && (f = !0, c = m, m > g && (c = g)), g < p.minPos) {
            f = !0;
            var y = p.minPos - m;
            c = y, g > y && (c = g)
        }
        var w = c - _, E = Math.abs(Math.round(u / e));
        if (0 != d && (E = E * w / d), _ != c) {
            var T = {left: c + "px"};
            1 == I && (T = {top: c + "px"}), b.animate(T, {
                duration: E,
        ...
        if (1 == f) {
            var j = P.returnAnimateSpeed, x = {left: v + "px"};
            1 == I && (x = {top: v + "px"}), b.animate(x, {
                duration: j,
    ...
    var h, p, m, f, v, b, y, I, w = new UGFunctions, P = {
    ...
    this.enable = function () {
        ...
        h = e, f = e.getObjects(), p = f.g_gallery, m = f.g_objGallery, v = f.g_objStrip, b = f.g_objStripInner, y = f.g_options, I = f.isVertical, t(), c()
...
function UGWistiaAPI() {
    ...
    function t(e, t, n, a, o) {
        r = null, s = !1;
        var l = e + "_video", u = "<div id='" + l + "' class='wistia_embed' style='width:" + n + ";height:" + a + ";' data-video-width='" + n + "' data-video-height='" + a + "'>&nbsp;</div>";
    ...
    this.isAPILoaded = !1;
    var n, r, a = this, o = jQuery(this), s = !1;
    this.events = {START_PLAYING: "start_playing", STOP_PLAYING: "stop_playing"}, this.loadAPI = function () {
...
function UGSoundCloudAPI() {
    ...
    this.isAPILoaded = !1;
    var n, r, a, o = this, s = jQuery(this);
    this.events = {START_PLAYING: "start_playing", STOP_PLAYING: "stop_playing"}, this.loadAPI = function () {
...
function UGHtml5MediaAPI() {
    ...
    function t(e, t, n, a, o) {
        r = null, g_isPlayerReady = !1;
        var s = location.protocol + "//cdnjs.cloudflare.com/ajax/libs/mediaelement/2.13.2/js/flashmediaelement-cdn.swf", l = location.protocol + "//cdnjs.cloudflare.com/ajax/libs/mediaelement/2.13.2/js/silverlightmediaelement.xap", u = e + "_video", d = "";
...
function UGVimeoAPI() {
    ...
    this.isAPILoaded = !1;
    var n, r, a = this, o = jQuery(this), s = null, l = !1, u = !1;
    this.events = {START_PLAYING: "start_playing", STOP_PLAYING: "stop_playing"}, this.loadAPI = function () {
...
function UGYoutubeAPI() {
    function e(e, t, r, o, u) {
        s && l && s.destroy();
        var d = {controls: 2, showinfo: 1, rel: 0};
    ...
    this.isAPILoaded = !1;
    var r, a, o = this, s = null, l = !1, u = jQuery(this), d = -1;
    this.events = {
...
function UGVideoPlayer() {
    ...
    function n() {
        d && (p.setButtonMobileReady(d), p.setButtonOnClick(d, e)), jQuery(m).on(m.events.START_PLAYING, t), jQuery(m).on(m.events.STOP_PLAYING, i), jQuery(f).on(f.events.START_PLAYING, t), jQuery(f).on(f.events.STOP_PLAYING, i), jQuery(v).on(v.events.START_PLAYING, t), jQuery(v).on(v.events.STOP_PLAYING, i), jQuery(b).on(b.events.START_PLAYING, t), jQuery(b).on(b.events.STOP_PLAYING, i), jQuery(y).on(y.events.START_PLAYING, t), jQuery(y).on(y.events.STOP_PLAYING, i)
    }
    ...
    var a, o, s, l, u, d, _, g, c = this, h = jQuery(this), p = new UGFunctions, m = new UGYoutubeAPI, f = new UGVimeoAPI, v = new UGHtml5MediaAPI, b = new UGSoundCloudAPI, y = new UGWistiaAPI, I = {};
    this.events = {SHOW: "show", HIDE: "hide"};
    var w = {
        standAloneMode: !1,
        youtubeInnerID: "",
        vimeoPlayerID: "",
    ...
    this.init = function (e, t, i) {
        ...
        I = jQuery.extend(I, e), t && 1 == t && (w.standAloneMode = !0)
    }, this.setHtml = function (e) {
        w.youtubeInnerID = a + "_youtube_inner", w.vimeoPlayerID = a + "_videoplayer_vimeo", w.html5PlayerID = a + "_videoplayer_html5", w.wistiaPlayerID = a + "_videoplayer_wistia", w.soundCloudPlayerID = a + "_videoplayer_soundcloud";
        var t = "<div class='ug-videoplayer' style='display:none'>";
        t += "<div class='ug-videoplayer-wrapper ug-videoplayer-youtube' style='display:none'><div id='" + w.youtubeInnerID + "'></div></div>", t += "<div id='" + w.vimeoPlayerID + "' class='ug-videoplayer-wrapper ug-videoplayer-vimeo' style='display:none'></div>", t += "<div id='" + w.html5PlayerID + "' class='ug-videoplayer-wrapper ug-videoplayer-html5'></div>", t += "<div id='" + w.soundCloudPlayerID + "' class='ug-videoplayer-wrapper ug-videoplayer-soundcloud'></div>", t += "<div id='" + w.wistiaPlayerID + "' class='ug-videoplayer-wrapper ug-videoplayer-wistia'></div>", 0 == w.standAloneMode && (t += "<div class='ug-videoplayer-button-close'></div>"), t += "</div>", e.append(t), o = e.children(".ug-videoplayer"), s = o.children(".ug-videoplayer-youtube"), l = o.children(".ug-videoplayer-vimeo"), u = o.children(".ug-videoplayer-html5"), _ = o.children(".ug-videoplayer-soundcloud"), g = o.children(".ug-videoplayer-wistia"), 0 == w.standAloneMode && (d = o.children(".ug-videoplayer-button-close"))
    }, this.initEvents = function () {
        n()
    }, this.setSize = function (e, t) {
        o.height(t), o.width(e), d && p.placeElement(d, "right", "top")
    }, this.getObject = function () {
        return o
    }, this.show = function () {
        return 1 == c.isVisible() ? !0 : (o.show(), d && d.show(), void h.trigger(c.events.SHOW))
    }, this.hide = function () {
        return 0 == c.isVisible() ? !0 : (r(), o.hide(), void h.trigger(c.events.HIDE))
    }, this.isVisible = function () {
        return o.is(":visible")
    }, this.playYoutube = function (e, t) {
        if ("undefined" == typeof t)var t = !0;
        r("youtube"), s.show(), 1 == m.isPlayerReady() && 1 == w.standAloneMode ? m.changeVideo(e, t) : m.putVideo(w.youtubeInnerID, e, "100%", "100%", t)
    }, this.playVimeo = function (e, t) {
        if ("undefined" == typeof t)var t = !0;
        r("vimeo"), l.show(), f.isPlayerReady() && 1 == w.standAloneMode ? f.changeVideo(e, t) : f.putVideo(w.vimeoPlayerID, e, "100%", "100%", t)
    }, this.playHtml5Video = function (e, t, i, n, a) {
        if ("undefined" == typeof a)var a = !0;
        r("html5"), u.show();
        var o = {ogv: e, webm: t, mp4: i, posterImage: n};
        v.putVideo(w.html5PlayerID, o, "100%", "100%", a)
    }, this.playSoundCloud = function (e, t) {
        if ("undefined" == typeof t)var t = !0;
        r("soundcloud"), _.show(), b.putSound(w.soundCloudPlayerID, e, "100%", "100%", t)
    }, this.playWistia = function (e, t) {
        if ("undefined" == typeof t)var t = !0;
        r("wistia"), g.show(), y.putVideo(w.wistiaPlayerID, e, "100%", "100%", t)
    }
}
function UGZoomSliderControl() {
    function e(e, t) {
        P = e, w = jQuery(P), g_objects = e.getObjects(), y = g_objects.g_objSlider, I = g_objects.g_objInner, E = jQuery.extend(E, t), b()
    }
    ...
    function i() {
        var e = jQuery.now(), i = e - T.storeImageLastTime;
        if (20 > i)return !1;
    ...
    function n(e, i) {
        var n = P.getSlidesReference(), r = n.objCurrentSlide.find("img"), a = t();
        w.trigger(P.events.ZOOM_START);
        var o = !0;
        if ("back" == e) {
        ...
        1 == o && (w.trigger(P.events.ZOOMING), w.trigger(P.events.ZOOM_CHANGE), w.trigger(P.events.ZOOM_END))
    }
    ...
    function s(e) {
        ...
        var t = S.getMousePosition(e), i = (t.pageX - T.startMouseX, t.pageY - T.startMouseY, t.pageX - T.lastMouseX), n = t.pageY - T.lastMouseY, r = 0 > i ? "left" : "right", a = 0 > n ? "up" : "down";
        ...
        var s = o.left + i, l = o.top + n;
        S.placeElement(T.objImage, s, l)
    }

    function l() {
        var e = !1, t = !1, i = 0, n = 0, r = S.getElementSize(T.objImage), a = S.getElementCenterPosition(T.objImage);
    ...
    function d(e) {
        ...
        0 == t && (T.imageOrientPoint = S.getElementCenterPoint(T.objImage)), w.trigger(P.events.ZOOM_START)
    }

    function _(e) {
        if (0 == T.isZoomActive)return !1;
        var t = S.getArrTouches(e);
        2 != t.length && (T.isZoomActive = !1, w.trigger(P.events.ZOOM_END))
    }
    ...
    function c(e) {
        var t = S.getArrTouches(e), i = S.getDistance(t[0].pageX, t[0].pageY, t[1].pageX, t[1].pageY), n = i / T.startDistance, r = S.getMiddlePoint(t[0].pageX, t[0].pageY, t[1].pageX, t[1].pageY), a = T.objImageSize.width * n, o = T.objImageSize.height * n, s = S.getImageOriginalSize(T.objImage), l = 1;
        ...
        var u = r.x - T.startMiddlePoint.x, d = r.y - T.startMiddlePoint.y, _ = T.startImageX + panX + u, g = T.startImageY + panY + d;
        S.setElementSizeAndPosition(T.objImage, _, g, a, o), w.trigger(P.events.ZOOMING), w.trigger(P.events.ZOOM_CHANGE)
    }
    ...
    function h() {
        ...
        if (e.width < T.objFitImageSize.imageWidth) {
            T.objImage.css({position: "absolute", margin: "none"});
            var t = {
    ...
    function m(e) {
        ...
        i();
        if (void 0 == T.objImage || 0 == T.objImage.length)return !0;
        var n = T.isPanActive, a = T.isZoomActive;
        if (0 == P.isInnerInPlace())return T.isZoomActive = !1, T.isPanActive = !1, !0;
        if (1 == T.isZoomActive ? _(e) : g(e), 1 == T.isZoomActive)0 == T.isPanActive; else {
    ...
    function v(e, t) {
        if (0 == P.isCurrentSlideType("image"))return !0;
        e.preventDefault();
        var i = t > 0, r = S.getMousePosition(e), a = 1 == i ? "in" : "out";
        n(a, r)
    }

    function b() {
        y.on("mousewheel", v), y.bind("mousedown touchstart", p), jQuery("body").bind("mousemove touchmove", f), jQuery(window).add("body").bind("mouseup touchend", m), w.bind(P.events.BEFORE_RETURN, function () {
            h()
        }), w.bind(P.events.ITEM_CHANGED, function () {
            T.isZoomedOnce = !1
        }), w.bind(P.events.ZOOM_CHANGE, function () {
            T.isZoomedOnce = !0
        })
    }

    var y, I, w, P = new UGSlider, S = new UGFunctions, E = {
...
!function (e) {
    ...
    function t(t) {
        var o = t || window.event, s = l.call(arguments, 1), u = 0, d = 0, _ = 0, g = 0;
    ...
    var r, a, o = ["wheel", "mousewheel", "DOMMouseScroll", "MozMousePixelScroll"], s = "onwheel"in document || document.documentMode >= 9 ? ["wheel"] : ["mousewheel", "DomMouseScroll", "MozMousePixelScroll"], l = Array.prototype.slice;
    ...
    function n(t) {
        ...
        return t = t.toLowerCase(), h(l, function (e, r) {
            var a, o = r.re.exec(t), s = o && r.parse(o), l = r.space || "rgba";
    ...
    var a, o = "backgroundColor borderBottomColor borderLeftColor borderRightColor borderTopColor color columnRuleColor outlineColor textDecorationColor textEmphasisColor", s = /^([\-+])=\s*(\d+\.?\d*)/, l = [{
    ...
    c.style.cssText = "background-color:rgba(1,1,1,.5)", g.rgba = c.style.backgroundColor.indexOf("rgba") > -1, h(d, function (e, t) {
        ...
        parse: function (r, o, s, l) {
            ...
            var n = u(e), r = n._space(), a = d[r], o = 0 === this.alpha() ? u("transparent") : this, s = o[a.cache] || a.to(o._rgba), l = s.slice();
            return n = n[a.cache], h(a.props, function (e, r) {
                var a = r.idx, o = s[a], u = n[a], d = _[r.type] || {};
        ...
        u.fn[n] = function (n) {
            ...
            u.fn[t] || (u.fn[t] = function (r) {
                var a, o = e.type(r), l = "alpha" === t ? this._hsla ? "hsla" : "rgba" : n, u = this[l](), d = u[i.idx];
                ...
                set: function (t, r) {
                    ...
                    if ("transparent" !== r && ("string" !== e.type(r) || (a = n(r)))) {
                        if (r = u(a || r), !g.rgba && 1 !== r._rgba[3]) {
                            for (o = "backgroundColor" === i ? t.parentNode : t; ("" === s || "transparent" === s) && o && o.style;)try {
